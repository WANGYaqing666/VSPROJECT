...
int main(int argc, char** argv)
{
	...
	//capture.open("E:/openCV/video/video_006.mp4");
	if (!capture.isOpened())
	{
	...
	printf("FPS;%f", fps);
	VideoWriter writer("E:/openCV/video/wv_demo4.avi", -1, 15.0, size, true);
...
void drawTrackLines()
{
	...
	{			
			line(frame, iniPoints[t], fpts[1][t], randomColor(rng), 1, 8, 0);//绿色的线
